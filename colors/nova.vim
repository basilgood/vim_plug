...
function! s:highlight_helper(...)
  ...
  let l:background_color = empty(a:3) ? "#1b2b34" : a:3
...
call s:highlight_helper("SpecialKey", "#75715e", "")
call s:highlight_helper("NonText", "#75715e", "")
...
" TRIVIAL
call s:highlight_helper("Comment", "#75713e", "")
